# 🚀 Rudy — Fullstack Developer & Infrastructure Engineer
...
## 📄 Key Features of Portfolio Website

- **Zero-Dependency Core**: Built with 0 KB heavy external JavaScript frameworks for instant loading speeds on GitHub Pages.
- **Tactical Cyberpunk Design**: Custom dark-mode UI styled with Electric Cyan (`#00f3ff`) and Cyber Emerald (`#00ff9d`), utilizing `Plus Jakarta Sans` & `JetBrains Mono` typography.
- **Interactive Terminal Widget**: Simulates live `rudy@infra-node:~` terminal status & stack verification.
- **Bento Grid Portfolio**: Showcase of field evidence photos, network topologies, and project metrics.
- **Category Filter & Fullscreen Lightbox**: Real-time project filtering and image preview modal with zero page reloads.
...
- **Live Website**: [https://rudy0317.github.io/rudy-dev/](https://rudy0317.github.io/rudy-dev/)
- **GitHub**: [@rudy0317](https://github.com/rudy0317)
- **LinkedIn**: [linkedin.com/in/rudyyy](https://www.linkedin.com/in/rudyyy)
- **WhatsApp**: [+62 896-3007-8446](https://wa.me/6289630078446)
